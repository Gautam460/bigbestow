...
export default function Edit({ category }) {
    const isInitialUrl = typeof category.image === 'string' && category.image.startsWith('http');
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 className="text-2xl font-black text-slate-900 uppercase italic tracking-tight">Edit <span className="text-yellow-500">Category</span></h2>
                    <p className="text-slate-500 text-sm">Update category name and banner image.</p>
                </div>
            </div>
            ...
            <form onSubmit={submit} className="space-y-8">
                ...
                <div className="pt-4 flex items-center gap-4">
                    ...
                    >
                        {processing ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Save className="w-5 h-5" /> UPDATE CATEGORY</>}
                    </button>
                    <Link
                        href="/admin/categories"
