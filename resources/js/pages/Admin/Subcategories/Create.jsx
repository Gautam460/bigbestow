    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 className="text-2xl font-black text-slate-900 uppercase italic tracking-tight">Add <span className="text-yellow-500">New Subcategory</span></h2>
                    <p className="text-slate-500 text-sm">Create nested subcategories under parent product categories.</p>
                </div>
            </div>
            ...
            <form onSubmit={submit} className="space-y-8">
                ...
                <div className="pt-4 flex items-center gap-4">
                    ...
                    >
                        {processing ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Save className="w-5 h-5" /> PUBLISH SUBCATEGORY</>}
                    </button>
                    <Link
                        href="/admin/subcategories"
