...
export default function Edit({ product, categories = [], subcategories = [] }) {
    const isInitialUrl = typeof product.image === 'string' && product.image.startsWith('http');
    const [imageType, setImageType] = useState(isInitialUrl ? 'url' : 'file');
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 className="text-2xl font-black text-slate-900 uppercase italic tracking-tight">Edit <span className="text-yellow-500">Product</span></h2>
                    <p className="text-slate-500 text-sm">Update specifications, pricing, and images for #{product.id}.</p>
                </div>
            </div>
            ...
            <form onSubmit={submit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                        <div className="md:col-span-2 space-y-2">
                            {imageType === 'url' ? (
                                ...
                                <div>
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Upload New Image File</label>
                                    <input
                                        type="file"
                                        accept="image/*"
                ...
                <div className="pt-4 flex items-center gap-4">
                    ...
                    >
                        {processing ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Save className="w-5 h-5" /> UPDATE PRODUCT</>}
                    </button>
                    <Link
                        href="/admin/products"
