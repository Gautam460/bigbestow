        ...
        <EcommerceLayout>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-500 dark:text-slate-400 max-w-2xl mx-auto">Everything we do is guided by these four principles.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="bg-gray-50 dark:bg-slate-900 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-lg transition-shadow">
                        <div className="bg-white dark:bg-slate-800 w-14 h-14 rounded-xl flex items-center justify-center shadow-sm mb-6">
                            <Target className="w-7 h-7 text-indigo-600" />
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Uncompromising Quality</h3>
                        <p className="text-gray-600 dark:text-slate-400">We source the finest materials and brands to ensure every product stands the test of time.</p>
                    </div>
                    ...
                    <div className="bg-gray-50 dark:bg-slate-900 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-gray-600 dark:text-slate-400">We listen to our customers. Your feedback directly shapes our catalog and deals.</p>
                    </div>
                    ...
                    <div className="bg-gray-50 dark:bg-slate-900 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-lg transition-shadow">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Trust & Reliability</h3>
                        <p className="text-gray-600 dark:text-slate-400">We are committed to secure transactions, fast delivery, and honest customer policies.</p>
                    </div>
                    ...
                    <div className="bg-gray-50 dark:bg-slate-900 p-8 rounded-2xl border border-gray-100 dark:border-slate-700 hover:shadow-lg transition-shadow">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Fast Innovation</h3>
                        <p className="text-gray-600 dark:text-slate-400">Shopping trends move fast, and so do we. We constantly update our store to match global styles.</p>
                    </div>
                </div>
            </div>

            {/* Story Section */}
            <div className="bg-white dark:bg-slate-800 border-t border-gray-100 dark:border-slate-700 py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div className="w-full md:w-1/2 space-y-6">
                        ...
                        <h2 className="text-4xl font-black text-gray-900 dark:text-white">How it all started.</h2>
                        ...
                        <ul className="space-y-4 mt-6">
                            <li className="flex items-center gap-3 text-gray-700 dark:text-slate-300 font-medium">
